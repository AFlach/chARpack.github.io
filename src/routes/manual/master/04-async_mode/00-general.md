...
need to perform one of the actions specified in <a href="/manual/master/04-async_mode/01-transition-modes">Transition Modes and Options</a>.
...
To start the scan, press the **Scan Screen** button in the <a href="/manual/master/01-first_start/00-login_screen">Login Menu</a>.
...
<img src="/images/manual/master/scan_screen_instructions.png" alt="Screen scan instructions" class="mx-auto max-w-xl" />
...
<img src="/images/manual/master/scan_screen_recording.gif" alt="Screen scan example" class="mx-auto max-w-md" />
