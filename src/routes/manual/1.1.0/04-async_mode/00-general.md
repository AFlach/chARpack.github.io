...
need to perform one of the actions specified in <a href="/manual/1.1.0/04-async_mode/01-transition-modes">Transition Modes and Options</a>.
...
To start the scan, press the **Scan Screen** button in the <a href="/manual/1.1.0/01-first_start/00-login_screen">Login Menu</a>.
