...
<img src="/images/manual/1.1.0/login_menu.png" alt="Login Screen Menu" class="mx-auto max-w-md" />
...
#### Scan Screen
The button **Scan Screen** lets you scan your desktop screen to enable <a href="/manual/1.1.0/04-async_mode/00-general">Async Mode</a> interactions.

#### Settings
The button **Settings** opens a menu containing different <a href="/manual/1.1.0/02-normal_mode/02-settings">settings</a>; 
...
<img src="/images/manual/1.1.0/debug_log.png" alt="Debug Log" class="mx-auto max-w-sm" />
