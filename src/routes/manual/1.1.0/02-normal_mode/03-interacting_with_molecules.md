...
<img src="/images/manual/1.1.0/atom_interaction.png" alt = "Atom interaction" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.1.0/box_interaction.png" alt="Box interaction" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.1.0/merge.gif" alt="Merge" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.1.0/select.gif" alt="Select" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.1.0/fragment_rotation.gif" alt="Fragment Rotation Mode" class="mx-auto max-w-md" />
...
A simple measurement between two atoms will draw a dashed line between them, labelled with their current distance in Angstrom (you can change the unit of measurement to picometers in the <a href="/manual/1.1.0/02-normal_mode/02-settings">Settings</a> menu).
...
<img src="/images/manual/1.1.0/measurement.gif" alt="Measurment Mode" class="mx-auto max-w-md" />
