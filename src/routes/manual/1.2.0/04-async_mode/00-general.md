...
<img src="/images/manual/1.2.0/scan_screen_instructions.png" alt="Screen scan instructions" class="mx-auto max-w-xl" />
...
<img src="/images/manual/1.2.0/scan_screen_recording.gif" alt="Screen scan example" class="mx-auto max-w-md" />
