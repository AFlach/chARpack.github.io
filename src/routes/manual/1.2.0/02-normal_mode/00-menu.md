...
<img src="/images/manual/1.2.0/normal_mode_menu.png" alt="Normal Mode Menu" class="mx-auto max-w-md" />
...
This menu can be navigated by using a scrolling gesture with your index finger; pressing a button within this menu creates a new atom of the chosen type.

<img src="/images/manual/1.2.0/atom_menu.png" alt="Atom Menu" class="mx-auto max-w-md" />
