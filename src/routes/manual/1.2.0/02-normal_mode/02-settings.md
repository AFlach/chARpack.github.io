...
title: Settings
---
The settings menu is divided into multiple tabs.
...
### Post processing
This button toggles chARpacks post processing effects like cartoon-style shading.

## Hand Settings

![Hand Settings Menu](hand_settings_menu.png)
...
You may also decide whether measurements made on your device should be transmitted to the server via the network; by default, this behavior is active.
...
### Color scheme
chARpack support multiple different color schemes that change the background color of menus.
