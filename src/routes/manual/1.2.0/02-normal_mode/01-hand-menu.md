...
<img src="/images/manual/1.2.0/hand_menu.gif" alt="Hand Menu" class="mx-auto max-w-md" />
...
- **Fragment rotation mode button**: Pressing this toggles the interaction mode that enables fragment rotation/moving an entire chain of connected atoms in a certain direction.
- **Measurement mode button**: Is used to activate/deactivate the interaction mode used for measuring angles and distances.