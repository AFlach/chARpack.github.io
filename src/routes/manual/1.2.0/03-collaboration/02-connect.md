...
<img src="/images/manual/1.2.0/server_list.png" alt="Server List" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.2.0/network_settings.png" alt="Network Settings" class="mx-auto max-w-md" />
