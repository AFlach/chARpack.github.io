...
<img src="/images/manual/1.2.0/server_molecule_creation.png" alt="Creating molecules on the server" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.2.0/server_tooltip.png" alt="Server Tooltip" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.2.0/structure_formula.png" alt="Structure Formula" class="mx-auto max-w-md" />
...
<img src="/images/manual/1.2.0/info_panel.png" alt="Info panel" class="mx-auto max-w-md" />