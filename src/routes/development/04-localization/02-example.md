...
For more information see the [MRTK3 documentation](https://learn.microsoft.com/en-us/dotnet/api/mixedreality.toolkit.ux.pressablebutton?view=mrtkuxcore-3.2) or look at other examples of buttons in the project.
...
Content other than text can also be localized, see the [documentation of Localization package](https://docs.unity3d.com/Packages/com.unity.localization@1.3/manual/QuickStartGuideWithVariants.html).
